...
현재 앱은 OpenAI/Gemini API에 직접 연결하며 이 PC 서버를 사용하지 않습니다. 키 등록용 오프라인 QR 도구는 `make_setup_qr.py`이고, 사용 방법은 [프로젝트 README](../README.md)를 참고하세요. 아래 서버 연결·음성·PC 작업·3DoF 설명은 보존된 이전 구현의 기록입니다.
